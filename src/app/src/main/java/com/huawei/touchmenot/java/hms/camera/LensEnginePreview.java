 ...
 */
package com.huawei.touchmenot.java.hms.camera;
...
public class LensEnginePreview extends ViewGroup {
    ...
    private class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surface) {
            ...
            try {
                ...
                Log.d(LensEnginePreview.TAG, Constants.CAMERE_NOT_SOURCE, e);
            }
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int childWidth;
        int childHeight;
        int childXOffset = Constants.INIT_ZERO;
        int childYOffset = Constants.INIT_ZERO;
        ...
        for (int i = Constants.INIT_ZERO; i < this.getChildCount(); ++i) {
            // One dimension will be cropped. We shift child over or up by this offset and adjust
            // the size to maintain the proper aspect ratio.
            this.getChildAt(i).layout(INIT_MINUS_ONE * childXOffset, INIT_MINUS_ONE * childYOffset, childWidth - childXOffset,
    ...
    private boolean isPortraitMode() {
        ...
        Log.d(LensEnginePreview.TAG, Constants.STR_IS_POTRAIT_MODE);
        return false;
    }
}