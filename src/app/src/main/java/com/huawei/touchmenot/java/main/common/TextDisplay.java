...
public class TextDisplay {
    ...
    private void showTextInfo(String text) {
        if (mTextInfoListener != null) {
            mTextInfoListener.textInfoChanged(text, Constants.INIT_ZERO, Constants.INIT_ZERO);
        }
    }

    private void showTextInfo() {
        if (mTextInfoListener != null) {
            mTextInfoListener.textInfoChanged(null, Constants.INIT_ZERO, Constants.INIT_ZERO);
        }
    }
}
