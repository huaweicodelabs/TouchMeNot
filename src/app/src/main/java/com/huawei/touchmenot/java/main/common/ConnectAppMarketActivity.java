    ...
    private void showAppMarket() {
        ...
        dialog.setNegativeButton(R.string.arengine_cancel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(ConnectAppMarketActivity.this,R.string.AR_NOT_SUPPORTING,Toast.LENGTH_SHORT).show();
                startActivity(new Intent(ConnectAppMarketActivity.this, LiveFaceDetectionHMSActivity.class));
                finish();
            }
        });
        dialog.setPositiveButton(R.string.arengine_install, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    ...
                    throw new ARFatalException(Constants.STR_AR_INSTALL_ACTIVITY);
                }
            }
        });
